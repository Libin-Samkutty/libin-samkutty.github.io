...
## Retrieval metrics are worth having — where they apply
...
That catch is the argument for architecture-specific evaluation, not against it. The metric that saved that release is undefined on five of the six programs. Running it everywhere would not have made anything safer; it would have produced five more numbers nobody could interpret and one that mattered.
